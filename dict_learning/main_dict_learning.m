...
if figs == true
    ...
    plot(time_vec_dbgd,rec_vec_dbgd,'>-','DisplayName','DBGD','MarkerIndices', marker_idx_dbgd, 'Color',"#77AC30")
    ...
    semilogy(time_vec_dbgd,loss_vec_up_dbgd,'>-','DisplayName','DBGD','MarkerIndices', marker_idx_dbgd, 'Color',"#77AC30")
